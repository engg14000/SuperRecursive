...
| Need | Go to | Best for |
|------|-------|----------|
| Build a coding agent | `autonomous-agents/` | Claude Code, Devin |
| Coordinate agent teams | `multi-agent/` | Complex projects |
| Define tool interfaces | `tool-calling/` | API integrations |
